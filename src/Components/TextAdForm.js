    ...
    return (
        <div className='p-8'>
            <div className="md:max-w-[1480px] max-w-[600px] text-left m-auto w-full h-full border md:px-0 px-8  p-6 bg-white rounded-md shadow-md">
                ...
                <form className='grid md:grid-cols-2 gap-4 w-full px-8 '>
                    <div className="mb-4">
                    ...
                    <div className="mb-4 row-span-2">
                        ...
                        <textarea
                            ...
                            rows="4"
                            className="mt-1 p-2 text-xs w-full border rows-4 border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                    ...
                    <div className="mb-4 col-span-full">
                        ...
                        <input
                            ...
                            className="mt-1 p-2 w-full border text-xs border-gray-300 rounded-md focus:outline-none focus:border-blue-500"

                        />
                    </div>
                    <div className="mt-6 col-span-full flex justify-end gap-2">
                        ...
                        <button
                            ...
                            type="submit"
                            className="px-8 py-3 bg-blue-500 text-white p-3 rounded-md focus:outline-none hover:bg-blue-600">
                            Submit
                        </button>
                    </div>
                </form>
